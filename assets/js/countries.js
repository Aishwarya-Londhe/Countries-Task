...
let countries = [
                ...
                <div class="card">
                    <figure class = "CountryCard">
                        ...
                        <figcaption>
                            ...
                            <ul type = "none">
                                <li><strong>Capital:</strong> ${countryobj.capital}</li>
                                <li><strong>Languages:</strong> ${countryobj.languages}</li>
                                <li><strong>Population:</strong> ${countryobj.population}</li>
                            </ul>
                        </figcaption>
                    </figure>
                </div>
  ...
  countriesContainer.innerHTML =result;